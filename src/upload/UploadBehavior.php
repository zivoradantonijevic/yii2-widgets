...
/**
 * UploadBehavior automatically upload file and fills the specified attribute
...
class UploadBehavior extends Behavior
{
    ...
    protected function getFileName($file)
    {
        if ($this->generateNewName) {
            ...
            $name = preg_replace("%\.{$file->extension}$%", '', $file->name);

            return $this->sanitize($name . '-' . ($this->nameSuffix ? $this->nameSuffix : '-') . uniqid() . '.' . $file->extension);
        }
    }
